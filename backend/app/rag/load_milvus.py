...
from .data_wikichess.fr import DATA_FR # Not using French currently.
...
# Petit modèle rapide (384 dims). Tu pourras passer à Qwen plus tard si tu veux.
...
def chunk_text(text: str, max_chars: int = 500) -> List[str]:
    # Découpage simple par blocs de ~500 caractères
    chunks, buf = [], []
    length = 0
