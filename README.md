...
This document focuses on frontend integration choices around interactive chessboards, with a particular emphasis on `ngx-chessboard`. It discusses:

- Why `ngx-chessboard` was selected over alternative libraries
